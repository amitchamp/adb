...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  ...
  <body>
    ...
    <?php if(isset($policy_brief_policy_options)) : ?>
      <?php print $policy_brief_policy_options; ?>
    <?php endif; ?>

    <?php if(isset($policy_brief_policy_recommendations)) : ?>
      <?php print $policy_brief_policy_recommendations; ?>
    <?php endif; ?>

    <?php if(isset($policy_brief_additional_resource)) : ?>
      <?php print $policy_brief_additional_resource; ?>
    <?php endif; ?>
