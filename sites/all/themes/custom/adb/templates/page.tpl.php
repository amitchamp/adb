...
/**
 * @file
 * ADB implementation to display a single Drupal page.
 *
 * Available variables:
 *
 * ADB supplied variables:
 ...
 * @see adb_preprocess_page()
 * @see adb_process_page()
 */
?>
<div class="page-wrapper <?php print $classes; ?>">
