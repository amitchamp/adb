...
<article class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="comment-right-wrapper">
    <div class="comment-author-duration-wrapper">
      <?php print $author; ?>
      <div class="comment-duration"><?php print $comment_duration; ?></div>
    </div>
    <div class="comment-metadata"><?php print $comment_submitted; ?></div>
